...
1.{#2-9-alternative}
  ...
  """"
  ----
  Firstly, there are instances where the boundary tracing ODE
  can be integrated analytically (e.g.~the plane-source fin).
  Secondly, solving ODEs numerically is far easier (and cheaper)
  than solving PDEs numerically.
  Yes, I think boundary tracing will be used practically.
  ----
